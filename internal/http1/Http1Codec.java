...
public final class Http1Codec implements HttpCodec {
    ...
    public void writeRequest(Headers headers, String str) throws IOException {
        ...
        this.sink.writeUtf8(str).writeUtf8(CTILogFileUtil.SEPARATOR_LINE);
        int size = headers.size();
        for (int i = 0; i < size; i++) {
            this.sink.writeUtf8(headers.name(i)).writeUtf8(": ").writeUtf8(headers.value(i)).writeUtf8(CTILogFileUtil.SEPARATOR_LINE);
        }
        this.sink.writeUtf8(CTILogFileUtil.SEPARATOR_LINE);
        this.state = 1;
    }
    ...
    public final class ChunkedSink implements Sink {
        ...
        public void write(Buffer buffer, long j) throws IOException {
            ...
            Http1Codec.this.sink.writeUtf8(CTILogFileUtil.SEPARATOR_LINE);
            Http1Codec.this.sink.write(buffer, j);
            Http1Codec.this.sink.writeUtf8(CTILogFileUtil.SEPARATOR_LINE);
        }
