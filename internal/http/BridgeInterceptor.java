...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (request.header("Accept-Encoding") == null && request.header(com.google.common.net.HttpHeaders.RANGE) == null) {
            z = true;
            newBuilder.header("Accept-Encoding", HttpStack.ENCODING_GZIP);
        }
        ...
        if (z && HttpStack.ENCODING_GZIP.equalsIgnoreCase(proceed.header("Content-Encoding")) && HttpHeaders.hasBody(proceed)) {
